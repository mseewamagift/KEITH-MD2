...
smd(
  ...
  async (message) => {
    const SupportMsg = `𝐊𝐄𝐈𝐓𝐇 𝐌𝐃 𝐎𝐅𝐅𝐈𝐂𝐀𝐋 𝐒𝐔𝐏𝐏𝐎𝐑𝐓 𝐆𝐑𝐎𝐔𝐏\n\n *ʟɪɴᴋ:*https://chat.whatsapp.com/GvR2YEfyhQQF85jp1rCLNn \n\n ${Config.botname} *WORKS*`;
